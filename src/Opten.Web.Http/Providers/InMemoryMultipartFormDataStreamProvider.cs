...
namespace Opten.Web.Http.Providers
{
	/// <summary>
	/// Used to store FormData files into an in-memory stream.
	/// </summary>
	/// <seealso cref="System.Net.Http.MultipartStreamProvider" />
	// Copied from: https://github.com/swimtver/Owin/blob/master/Owin.Web/Providers/InMemoryMultipartFormDataStreamProvider.cs
